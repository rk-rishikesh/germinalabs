...
export default function AgendaDetailPage() {
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row">
      ...
      <div className="flex-1 bg-neutral-900 text-white flex flex-col items-center justify-start p-6 sm:p-12">
            ...
            {agenda.map((item, idx) => (
              <li key={idx} className="flex items-center py-6">
                ...
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 rounded-full bg-green-400 flex items-center justify-center text-neutral-900 font-bold text-lg mr-6">
